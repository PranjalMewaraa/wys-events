...
const people=[
    ...
    message: "Let’s connect this evening to discuss"},
    {image:p2,
    name:"Aditi Wanderlust",
     message: "Sure we can discuss"},
    {image:p2,
    name:"Aditi Wanderlust",
    message: "Sure we can discuss"}
  ...
  return (
    <div className='w-full bg-gray-100'>
        ...
        <div className='w-full mt-14'>
            ...
            <button className={`w-1/3 ml-10 text-center  abeezee-regular text-base ${
            ...
            <button className={`w-1/3 abeezee-regular text-base text-center ${
    ...
    {(activeTab === 'people' ? people : group).map((person, index) => (
          <ChatList
            key={index}
            image={person.image}
            name={person.name}
