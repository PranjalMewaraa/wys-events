...
const Home = () => {
  ...
  const categoryList = [
    ...
    {
      label: "City Heritage & Food Walks",
      value: "City Heritage & Food Walks",
    },
    {
      label: "Nightlife & Social Meetups",
      value: "Nightlife & Social Meetups",
    },
          ...
          <div className="w-full py-2 px-4 flex gap-2 md:gap-4 max-w-[100vw] overflow-x-auto">
            {categoryList.map((cat, idx) => (
              <button
                ...
                className={`p-2 px-3 text-xs rounded-xl whitespace-nowrap border ${
