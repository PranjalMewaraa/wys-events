...
const Profile = () => {
      ...
      <div className="w-full h-full min-h-screen flex flex-col items-center justify-center p-4 bg-white">
        <div className="max-w-lg w-full flex items-center flex-col h-full">
          ...
          <div className="flex flex-col items-center">
            <img src={user.avatar} alt="Profile" className="w-24 h-24 rounded-md object-cover" />
          ...
          <div className="w-full mt-5">
            ...
            <div className="border-t p-3 flex items-center gap-3">
              ...
              <div className="flex items-center gap-3"><FaRegUser className="text-2xl" />
 ...
 <p>My companions</p>
    ...
    <div className="text-left w-full">
            ...
            Places worth <span className="text-orange-500">going</span>,<br></br> People worth <span className="text-orange-500">knowing</span>
          </p>
          </div>
