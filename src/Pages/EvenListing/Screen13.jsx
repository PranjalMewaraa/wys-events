  ...
  return (
    <main className="flex flex-col mx-auto w-full max-w-[480px]">
      <article className="flex overflow-hidden flex-col px-2 w-full bg-white">
        ...
        >
          ...
          <div className="flex flex-auto items-start">
            ...
            <div className="flex gap-0.5 items-start mt-4">
              ...
              />
              <img
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/0743b01b779c86ed1aadeece8a74684967c6dd13?placeholderIfAbsent=true&apiKey=4d8d61fdffcb4a598737f184e595e38e"
                alt="Status icon 3"
        ...
        <button
          className="flex flex-col items-start gap-1 self-start mt-2 ml-5"
