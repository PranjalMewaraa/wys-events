...
function EventDetails() {
  return (
    <main className="flex flex-col mx-auto w-full max-w-[480px]">
      <article className="flex overflow-hidden flex-col px-2 w-full bg-white">
        <header
          className="flex overflow-hidden gap-4 items-start pr-4 pb-2.5 pl-8 w-full bg-white"
          role="banner"
        >
          <time className="grow mt-3.5 text-base italic tracking-tight leading-snug text-black">
            9:41
          </time>
          <div className="flex flex-auto items-start">
            ...
            <div className="flex gap-0.5 items-start mt-4">
              ...
              />
              <img
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/bb6460858d393baeb4ae05f3fb9961b2afd05468?placeholderIfAbsent=true&apiKey=4d8d61fdffcb4a598737f184e595e38e"
                alt="Battery status"
        ...
        <section className="flex gap-5 justify-between self-center mt-3 w-full max-w-[341px]">
          <div className="flex flex-col items-start text-xs">
            ...
            <div className="flex gap-2 items-center mt-3 tracking-tight leading-3 text-black">
              <img
            ...
            <div className="flex gap-1 self-stretch mt-2">
              <div className="flex flex-col w-full">
                <div className="flex gap-2 self-start tracking-tight leading-3 text-black">
                  <img
                  ...
                  />
                  <address className="my-auto basis-auto">
                    Praygraj, Uttarakhand
                  </address>
                </div>
                <div className="flex gap-2 mt-2 tracking-tight">
                  <img
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/ecff1eaad42dc4af13c09630958a2dd9f496ed0e?placeholderIfAbsent=true&apiKey=4d8d61fdffcb4a598737f184e595e38e"
                    alt="Slots icon"
                    className="object-contain shrink-0 aspect-square w-[15px]"
                  />
                  <div className="flex gap-1 self-start text-black">
                    <span className="grow">Total Slots</span>
                    <span>7</span>
                  </div>
                  <span className="text-green-800">Slots Available</span>
                </div>
              </div>
              <span className="self-end mt-7 tracking-tight text-green-800">
                2
              </span>
            </div>
          </div>
          <div className="self-start px-3 py-2.5 text-xs tracking-tight text-center text-white bg-amber-500 rounded-3xl">
            Review submitted
          </div>
        </section>

        <div className="flex gap-2 self-start mt-2.5 ml-6 text-xs tracking-tight text-black">
          <img
            ...
            className="object-contain shrink-0 aspect-square w-[15px]"
          />
          <span className="basis-auto">Rs. 3000 per person</span>
        </div>

        <section className="flex gap-10 self-center py-1.5 pr-3 pl-1 mt-5 w-full tracking-tight bg-white border-t border-b border-zinc-800 max-w-[341px]">
          <div className="flex flex-1 gap-2.5 self-start mt-1.5 text-black">
            ...
            <div className="flex flex-col">
              <span className="self-start text-xs">Jhone Doe</span>
              <span className="mt-2.5 text-xs">active since 2025</span>
            </div>
          </div>
          <div className="flex flex-1 gap-2 text-white whitespace-nowrap">
            ...
            <div className="px-3 py-2 bg-green-800 rounded-xl">
              ...
              <div className="flex gap-0.5 text-xs">
                <span className="grow">4.2</span>
                <img
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/adce7dbc3d22fade09ba5077c1e045230462a286?placeholderIfAbsent=true&apiKey=4d8d61fdffcb4a598737f184e595e38e"
                  alt="Star icon"
        ...
        <section className="self-center mt-5 text-xs tracking-tight text-black">
          <p>
        ...
        <button
          className="flex flex-col items-start mt-2 ml-5"
          aria-label="Read more about the event"
        >
          <span className="text-xs tracking-tight text-black">Read More</span>
          <div className="shrink-0 h-px border border-black border-solid w-[49px]" />
        </button>

        <section className="mt-10">
          <h3 className="self-start ml-6 text-base tracking-tight text-black">
            Going
          </h3>
          <div className="flex gap-2.5 self-center pr-16 mt-3 max-w-full tracking-tight bg-white w-[329px]">
            <img
              ...
              alt="Attendee profile picture"
              className="object-contain shrink-0 aspect-[1.02] w-[41px]"
            />
            <div className="self-start">
              <span className="text-sm leading-loose text-black">
                Aditi Wanderlust
              </span>
              <span className="block text-xs leading-loose text-zinc-800">
